...
myTerminal :: String
myTerminal = "kitty -e fish"    -- Sets default terminal
...
myStartupHook = do
    ...
    spawnOnce "picom &"
    spawnOnce "wal -R &"
    spawnOnce "trayer --edge top --align right --widthtype request --padding 6 --SetDockType true --SetPartialStrut true --expand true --transparent true --alpha 0 --tint 0x282c34  --height 20 --monitor 1 &"
    spawnOnce "nm-applet &"
    spawnOnce "volumeicon &"
--    spawnOnce "discord &"
--    spawnOnce "steam-runtime &"
...
myWorkspaces = [" www ", " dev ", " term ", " steam ", " chat ", " mus "] ++ map show [7..9]
...
myKeys =
    ...
    -- Emacs (CTRL-e followed by a key)
        ...
        , ("M-E", spawn (myEmacs ++ ("--eval '(dashboard-refresh-buffer)'")))   -- emacs dashboard
...
main = do
    ...
    xmproc0 <- spawnPipe "xmobar -x 0 /home/payn/.config/xmobar/xmobarrc0"
    xmproc1 <- spawnPipe "xmobar -x 1 /home/payn/.config/xmobar/xmobarrc1"
